...
export const TRANSACTION_PENDING_MESSAGES = {
  ...
  [TransactionType.CreateLock]: 'Creating Position Pending.',
  [TransactionType.StakingUnlock]: 'Unlock Pending.',
  [TransactionType.StakingEarlyWithdrawal]: 'Early Unlock Pending.',
