...
export const CHECK_ON_BLOCK_EXPLORER = 'Click on transaction to view on Block Explorer.';
export const TRANSACTION_PENDING_MESSAGES = {
    ...
    [TransactionType.RemoveLiquidity]: 'Remove Liquidity from Stable Swap Pending.',
...
export const TRANSACTION_SUCCESS_MESSAGES = {
    ...
    [TransactionType.SwapTokenToStableCoin]: '${tokenName} token swapped to FXD successfully!',
    [TransactionType.SwapStableCoinToToken]: 'FXD token swapped to ${tokenName} successfully!',
    [TransactionType.AddLiquidity]: 'Successfully added Liquidity to Stable Swap!',
    [TransactionType.RemoveLiquidity]: 'Successfully removed Liquidity from Stable Swap!',
    [TransactionType.ClaimFeesRewards]: 'Claimed rewards successfully!',
    [TransactionType.WithdrawClaimedFees]: 'Withdrawal of claim fees was successful!',
    [TransactionType.CreateLock]: 'Lock position created successfully!',
    [TransactionType.HandleUnlock]: 'Position unlock was successful!',
    [TransactionType.HandleEarlyWithdrawal]: 'Handling Early Unlock was successful!',
