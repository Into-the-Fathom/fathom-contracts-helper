...
export default interface IStableSwapService {
    swapTokenToStableCoin(address: string, tokenIn: string, tokenInDecimals: number, tokenName: string): Promise<number | Error>;
    swapStableCoinToToken(address: string, stableCoinIn: string, tokenName: string): Promise<number | Error>;
    ...
    approveStableCoin(address: string, isStableSwapWrapper?: boolean): Promise<number | Error>;
    approveUsdt(address: string, isStableSwapWrapper?: boolean): Promise<number | Error>;
    claimFeesRewards(account: string): Promise<number | Error>;
    withdrawClaimedFees(account: string): Promise<number | Error>;
    approvalStatusStableCoin(address: string, tokenIn: string, inputDecimal: number, isStableSwapWrapper?: boolean): Promise<boolean>;
    approvalStatusUsdt(address: string, tokenIn: string, inputDecimal: number, isStableSwapWrapper?: boolean): Promise<boolean>;
    ...
    getClaimableFeesPerUser(account: string): Promise<{
        0: number;
        1: number;
    }>;
...
//# sourceMappingURL=IStableSwapService.d.ts.map