...
export default interface IStakingService {
    ...
    approveStakingFTHM(address: string, fthmTokenAddress: string): Promise<number | Error>;
    approvalStatusStakingFTHM(address: string, stakingPosition: number, fthmTokenAddress: string): Promise<boolean>;
    getStreamClaimableAmountPerLock(streamId: number, account: string, lockId: number): Promise<number>;
...
//# sourceMappingURL=IStakingService.d.ts.map