    ...
    createProposal(targets, values, callData, description, account) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                options.gas = gas;
                xdcPayV1EventHandler(FathomGovernor, resolve, reject, this.emitter, TransactionType.CreateProposal);
    ...
    executeProposal(targets, values, callData, description, account) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                options.gas = gas;
                xdcPayV1EventHandler(FathomGovernor, resolve, reject, this.emitter, TransactionType.ExecuteProposal);
    ...
    queueProposal(targets, values, callData, description, account) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                options.gas = gas;
                xdcPayV1EventHandler(FathomGovernor, resolve, reject, this.emitter, TransactionType.QueueProposal);
                FathomGovernor.methods
    ...
    castVote(proposalId, account, support) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                options.gas = gas;
                xdcPayV1EventHandler(FathomGovernor, resolve, reject, this.emitter, TransactionType.CastVote);
                return FathomGovernor.methods
